...
BASE_THEME=${baseTheme}`;
  ...
  initializeRibbonIconSetting() {
    new import_obsidian3.Setting(this.settingsRootElement).setName("Show ribbon icon").setDesc("Show ribbon icon in the obsidian sidepanel. You need to reload obsdian for changes to take effect.").addToggle((toggle) => toggle.setValue(this.settings.showRibbonIcon).onChange((value) => __async(this, null, function* () {
